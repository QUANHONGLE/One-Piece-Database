    ...
    <Router>
      <div className="text-center">
        ...
        >
          ...
          >
            {/* Audio Controls */}
            <div className="absolute -top-28 right-4 flex flex-row items-center gap-2.5 z-10">
              <button
                onClick={toggleMute}
                className="w-[clamp(40px,5vw,70px)] h-[clamp(40px,5vw,70px)] flex items-center justify-center leading-none border-[3px] border-[rgba(11,102,138,0.95)] rounded-full bg-[rgba(19,164,219,0.95)] text-[clamp(1rem,1.5vw,2rem)] font-bold text-white cursor-pointer shadow-[0_2px_6px_rgba(0,0,0,0.3)] transition-all duration-200 ease-in-out hover:scale-105 hover:border-white hover:shadow-[0_4px_10px_rgba(0,0,0,0.35)]"
                aria-pressed={muted}
                aria-label={
        ...
        {/* Navigation */}
        <nav className="flex gap-8 justify-evenly py-4 w-full mx-auto bg-[#13a4db] shadow-[0px_4px_12px_rgba(0,0,0,0.4)]">
          <NavLink
            to="/"
            className={({ isActive }) =>
              isActive
                ? "text-5xl font-one-piece [text-shadow:2px_2px_6px_rgba(0,0,0,2)] font-bold no-underline text-white transition-all duration-300 ease-in-out px-5 py-0 rounded-[30px] bg-[rgb(63,195,247)] hover:text-[#c7c7c7] hover:scale-105"
                : "text-5xl font-one-piece [text-shadow:2px_2px_6px_rgba(0,0,0,2)] font-bold no-underline text-white transition-all duration-300 ease-in-out hover:text-[#c7c7c7] hover:scale-105"
            }
          >
            CARD DATABASE
          </NavLink>
